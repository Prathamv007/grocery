...
public class EditProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get id of the product form intent
    ...
    private void loadProductDetails() {
        ...
        reference.child(firebaseAuth.getUid()).child(productId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        try {
                            Picasso.get().load(productIcon).placeholder(R.drawable.ic_add_shopping_white).into(productIconTv);
                        }
                        catch (Exception e) {
                            productIconTv.setImageResource(R.drawable.ic_add_shopping_white);
                        }
                    }
